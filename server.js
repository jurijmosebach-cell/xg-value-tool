...
const LEAGUES = [
  ...
  { key: "soccer_turkey_superlig", name: "Türkei Süper Lig" },
  { key: "soccer_australia_a_league", name: "Australien A-League" },
  { key: "soccer_belgium_first_div_a", name: "Belgien 1.Division A" },
  { key: "soccer_brazil_serie_a", name: "Brasilien Serie A" },
  { key: "soccer_china_super_league", name: "China Super League" },
  { key: "soccer_denmark_superligaen", name: "Dänemark Superligaen" },
  { key: "soccer_japan_j_league", name: "Japan J-League" },
...
function getFlag(team) {
  const flags = { "England":"gb","Germany":"de","Spain":"es","Italy":"it","France":"fr","USA":"us","Turkey":"tr","Australia":"au","Belgium":"be","Brazil":"br","China":"cn","Denmark":"dk","Japan":"jp","Netherlands":"nl","Norway":"no","Sweden":"se" };
